                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <h3 className="contact__card__title">
                                Email
                            </h3>
                            <span className="contact__card__data">
                                rilinda.xhaqkaj@gmail.com
                            </span>
                        ...
                        <div className="contact__card">
                            <i class='uil uil-linkedin-alt contact__card__icon'></i>
                            <h3 className="contact__card__title">
                                Linked In
                            </h3>
                            <span className="contact__card__data">
                ...
                <div className="contact__content">
                    ...
                    <form ref={form} onSubmit={sendEmail} className="contact__form">
                        ...
                        <div className="contact__form__div contact__form__area">
                            <label className="contact__form__tag">Description</label>
                            <textarea
                                name="project"
                                cols="30"
                                rows="10"
